...
const paramsWithId = (id: string | null) => new URLSearchParams(id ? { id } : {});

beforeEach(() => {
  push.mockClear();
  useSearchParams.mockReturnValue(paramsWithId('zzzz'));
...
describe('LobbyPage join form', () => {
  ...
  it('shows "Invalid lobby." when there is no ?id=', () => {
    useSearchParams.mockReturnValue(paramsWithId(null));
    render(<LobbyPage />);
