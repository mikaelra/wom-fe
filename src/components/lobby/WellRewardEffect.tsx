...
// ── Animation timing (seconds) -- scaled to 0.66x for snappier pacing ────────
const TRAVEL_DUR = 0.56; // arch from source → target
const HOLD_DUR   = 0.3;  // rest on the winner, then disappear instantly
